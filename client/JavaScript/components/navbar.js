const hamburger = document.querySelector(
  ".components-navbar-header .components-navbar-close-open .components-navbar-open"
);
const close = document.querySelector(
  ".components-navbar-header .components-navbar-close-open .components-navbar-close"
);
  ...
  for (let i = 0; i < addToCartButtons.length; i++) {
    ...
    button.addEventListener("click", function (event) {
      ...
      for (let i = 0; i < cartItemNames.length; i++) {
        ...
        if (
          cartItemNames[i].innerText.toUpperCase().trim() ===

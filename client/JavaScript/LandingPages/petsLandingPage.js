...
// let a = [];
// Productprice.forEach((p) => a.push(parseInt(p)));
...
//                     <p class="info cost">Rs.${price} <span>Rs.${
//     price * 1.25
//   }</span></p>
...
//   }
//   if (
//     (fullScreenSlider != 0 || n > 0) &&
//     (fullScreenSlider + n) * 4 < productName.length
//   ) {
...
//   if (productName[0] === "") {
//     products.innerHTML +=
//       "<h1 style='color:red'>No products are currently Available Please try again after some time</h1>";
//   } else {
//   }
//   for (i = 0; i < 4; i++) {
...
//     Append(
//       productName[slideNumber + i],
//       imgSrc[slideNumber + i],
//       Productprice[slideNumber + i]
//     );
//   }
//   // call()
// }
